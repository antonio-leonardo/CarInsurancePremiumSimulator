...
def _use_case(
    *,
    ...
    maximum_broker_fee: Decimal = Decimal("1e9"),
    maximum_vehicle_value: Decimal = Decimal("1e11"),
    ...
    return CalculatePremium(
        ...
        logger=FakeLogger(),
        maximum_broker_fee=maximum_broker_fee,
        maximum_vehicle_value=maximum_vehicle_value,
